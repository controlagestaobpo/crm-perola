  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-5">
      <div className="mb-4 flex items-center justify-between">
        <p className="text-sm font-medium text-slate-700">📅 Próximas atividades</p>
        <Link href="/agenda" className="text-xs font-medium text-violet-600 hover:underline">
          Ver agenda completa
        </Link>
      </div>
      {proximos.length === 0 ? (
        <p className="text-sm text-slate-400">Nenhum contato agendado. Direcione o dia registrando atendimentos com &quot;próximo contato&quot;.</p>
      ) : (

    ...
    <form ref={formRef} action={formAction} className="rounded-xl border border-slate-200 bg-white p-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
        <div>
          ...
          <input name="nome" required className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm" />
        </div>
        <div>
        ...
        <div>
          ...
          <select name="papel" defaultValue="vendedor" className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm">
